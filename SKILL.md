...
```json
[
  {"book_id": 79349679, "namespace": "yehuoshun/idx-java-1"},
  {"book_id": 79350288, "namespace": "yehuoshun/idx-python-1"}
]
```

> 一个关键词可能对应多个子索引库，entries 是数组。
> 总库条目指向子索引库，通过 book_id/namespace 定位。
> ⚠️ namespace 为子索引库的完整 namespace，如 `yehuoshun/idx-java-1`。
