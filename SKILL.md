...
```json
[
  {"book_id": 79349679, "namespace": "yehuoshun/idx-java-1/springboot"},
  {"book_id": 79350288, "namespace": "yehuoshun/idx-python-1/django"}
]
```

> 一个关键词可能对应多个子索引库，entries 是数组。
> 每个条目指向子库中的具体索引文档。
> ⚠️ namespace 为文档级路径，如 `yehuoshun/idx-java-1/springboot`（group/slug/slug）。
